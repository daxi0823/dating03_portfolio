    ...
    <main>
      <section id="mv" class="mv__less">
        <div class="copy__wrapper">
          ...
          <p><label>メニュー名：<input v-model="menuName" type="text"></label></p>
          <p><label>メニュー画像：<input ref="imgUp" type="file" id="fileImg"></label></p>
          <button @click="imgUpload">アップロード</button>
          <p><label>メニュー説明：<textarea v-model="menuTxt" cols="30" rows="10"></textarea></label></p>
